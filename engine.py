...
CITY_COORDS = {
    ...
    # US state capitals not already covered by a major-city entry above
    # (12 states' capitals ARE their major city already listed: Phoenix AZ,
    # Sacramento CA, Denver CO, Atlanta GA, Honolulu HI, Indianapolis IN,
    # Boston MA, Raleigh NC, Columbus OH, Nashville TN, Austin TX, Salt Lake
    # City UT - not duplicated here).
    "Montgomery, US": (32.3792, -86.3077), "Juneau, US": (58.3019, -134.4197),
    "Little Rock, US": (34.7465, -92.2896), "Hartford, US": (41.7658, -72.6734),
    "Dover, US": (39.1582, -75.5244), "Tallahassee, US": (30.4383, -84.2807),
    "Boise, US": (43.6150, -116.2023), "Springfield, US": (39.7817, -89.6501),
    "Des Moines, US": (41.5868, -93.6250), "Topeka, US": (39.0473, -95.6752),
    "Frankfort, US": (38.2009, -84.8733), "Baton Rouge, US": (30.4515, -91.1871),
    "Augusta, US": (44.3106, -69.7795), "Annapolis, US": (38.9784, -76.4922),
    "Lansing, US": (42.7325, -84.5555), "St. Paul, US": (44.9537, -93.0900),
    "Jackson, US": (32.2988, -90.1848), "Jefferson City, US": (38.5767, -92.1735),
    "Helena, US": (46.5891, -112.0391), "Lincoln, US": (40.8136, -96.7026),
    "Carson City, US": (39.1638, -119.7674), "Concord, US": (43.2081, -71.5376),
    "Trenton, US": (40.2206, -74.7597), "Santa Fe, US": (35.6870, -105.9378),
    "Albany, US": (42.6526, -73.7562), "Bismarck, US": (46.8083, -100.7837),
    "Oklahoma City, US": (35.4676, -97.5164), "Salem, US": (44.9429, -123.0351),
    "Harrisburg, US": (40.2732, -76.8867), "Providence, US": (41.8240, -71.4128),
    "Columbia, US": (34.0007, -81.0348), "Pierre, US": (44.3683, -100.3510),
    "Montpelier, US": (44.2601, -72.5754), "Richmond, US": (37.5407, -77.4360),
    "Olympia, US": (47.0379, -122.9007), "Charleston, US": (38.3498, -81.6326),
    "Madison, US": (43.0731, -89.4012), "Cheyenne, US": (41.1400, -104.8202),
    # AU
    ...
    # Actual state-capital corrections - Ahmedabad/Visakhapatnam above are each
    # state's largest city, not its real seat of government.
    "Gandhinagar, IN": (23.2156, 72.6369), "Amaravati, IN": (16.5062, 80.6480),
    "Jammu, IN": (32.7266, 74.8570),  # J&K's winter capital (Srinagar, already listed, is the summer capital)
    # DE
    ...
    # 3 remaining German state capitals not already covered by a bigger,
    # non-capital city in the same state (Frankfurt/Hesse, Rostock/
    # Mecklenburg-Vorpommern, Leipzig/Saxony are all listed above but aren't
    # their state's actual capital).
    "Wiesbaden, DE": (50.0782, 8.2398), "Schwerin, DE": (53.6355, 11.4012),
    ...
    # Remaining Brazilian state capitals (Sao Paulo/Rio de Janeiro/Brasilia/
    # Salvador/Curitiba/Fortaleza/Belo Horizonte/Manaus/Recife/Porto Alegre
    # above already cover their own states correctly - not duplicated here).
    "Rio Branco, BR": (-9.9754, -67.8249), "Maceio, BR": (-9.6658, -35.7350),
    "Macapa, BR": (0.0389, -51.0664), "Vitoria, BR": (-20.3155, -40.3128),
    "Goiania, BR": (-16.6799, -49.2550), "Sao Luis, BR": (-2.5307, -44.3068),
    "Cuiaba, BR": (-15.6014, -56.0979), "Campo Grande, BR": (-20.4697, -54.6201),
    "Belem, BR": (-1.4558, -48.4902), "Joao Pessoa, BR": (-7.1195, -34.8450),
    "Teresina, BR": (-5.0892, -42.8019), "Natal, BR": (-5.7945, -35.2110),
    "Porto Velho, BR": (-8.7619, -63.9039), "Boa Vista, BR": (2.8235, -60.6758),
    "Florianopolis, BR": (-27.5954, -48.5480), "Aracaju, BR": (-10.9472, -37.0731),
    "Palmas, BR": (-10.2491, -48.3243),
    # MX
    ...
    # Remaining Mexican state capitals - Tijuana/Leon/Juarez/Zapopan above are
    # each their state's largest city, not the actual seat of government
    # (Mexicali/Guanajuato/Chihuahua/Guadalajara are); Guadalajara, Merida,
    # Mexico City, Monterrey, Puebla above already ARE their state's real
    # capital, not duplicated here.
    "Aguascalientes, MX": (21.8853, -102.2916), "Mexicali, MX": (32.6245, -115.4523),
    "La Paz, MX": (24.1426, -110.3128), "Campeche, MX": (19.8301, -90.5349),
    "Tuxtla Gutierrez, MX": (16.7516, -93.1029), "Chihuahua, MX": (28.6353, -106.0889),
    "Saltillo, MX": (25.4260, -101.0053), "Colima, MX": (19.2433, -103.7250),
    "Durango, MX": (24.0277, -104.6532), "Guanajuato, MX": (21.0190, -101.2574),
    "Chilpancingo, MX": (17.5514, -99.5008), "Pachuca, MX": (20.1011, -98.7591),
    "Toluca, MX": (19.2926, -99.6568), "Morelia, MX": (19.7060, -101.1950),
    "Cuernavaca, MX": (18.9186, -99.2342), "Tepic, MX": (21.5041, -104.8942),
    "Oaxaca, MX": (17.0732, -96.7266), "Queretaro, MX": (20.5888, -100.3899),
    "Chetumal, MX": (18.5001, -88.2960), "San Luis Potosi, MX": (22.1565, -100.9855),
    "Culiacan, MX": (24.8091, -107.3940), "Hermosillo, MX": (29.0729, -110.9559),
    "Villahermosa, MX": (17.9895, -92.9475), "Ciudad Victoria, MX": (23.7369, -99.1411),
    "Tlaxcala, MX": (19.3182, -98.2374), "Xalapa, MX": (19.5438, -96.9102),
    ...
    # 3 remaining SA provincial capitals - East London/Durban above are each
    # their province's largest city, not the actual seat of government
    # (Bhisho/Eastern Cape, Pietermaritzburg/KwaZulu-Natal are).
    "Bhisho, ZA": (-32.8481, 27.4382), "Pietermaritzburg, ZA": (-29.6006, 30.3794),
    "Mahikeng, ZA": (-25.8560, 25.6403),
    # NZ
    ...
    # Remaining Nigerian state capitals - Lagos above is Lagos State's largest
    # city, not its capital (Ikeja is); Kano/Ibadan/Benin City/Kaduna/Enugu/
    # Port Harcourt/Abuja above already ARE their state's real capital.
    "Umuahia, NG": (5.5251, 7.4926), "Yola, NG": (9.2035, 12.4954),
    "Uyo, NG": (5.0377, 7.9128), "Awka, NG": (6.2120, 7.0741),
    "Bauchi, NG": (10.3158, 9.8442), "Yenagoa, NG": (4.9247, 6.2642),
    "Makurdi, NG": (7.7322, 8.5391), "Maiduguri, NG": (11.8333, 13.1500),
    "Calabar, NG": (4.9757, 8.3417), "Asaba, NG": (6.2059, 6.7305),
    "Abakaliki, NG": (6.3249, 8.1137), "Ado Ekiti, NG": (7.6211, 5.2214),
    "Gombe, NG": (10.2897, 11.1673), "Owerri, NG": (5.4840, 7.0351),
    "Dutse, NG": (11.7583, 9.3389), "Katsina, NG": (12.9908, 7.6018),
    "Birnin Kebbi, NG": (12.4534, 4.1975), "Lokoja, NG": (7.8023, 6.7333),
    "Ilorin, NG": (8.5000, 4.5500), "Ikeja, NG": (6.6018, 3.3515),
    "Lafia, NG": (8.4939, 8.5168), "Minna, NG": (9.6139, 6.5569),
    "Abeokuta, NG": (7.1475, 3.3619), "Akure, NG": (7.2571, 5.2058),
    "Osogbo, NG": (7.7719, 4.5569), "Jos, NG": (9.8965, 8.8583),
    "Sokoto, NG": (13.0059, 5.2476), "Jalingo, NG": (8.8833, 11.3667),
    "Damaturu, NG": (11.7470, 11.9608), "Gusau, NG": (12.1704, 6.6641),
    # SA
...
CITY_CANONICAL = {
    ...
    "Montgomery, US": "Montgomery,Alabama,United States",
    "Juneau, US": "Juneau,Alaska,United States",
    "Little Rock, US": "Little Rock,Arkansas,United States",
    "Hartford, US": "Hartford,Connecticut,United States",
    "Dover, US": "Dover,Delaware,United States",
    "Tallahassee, US": "Tallahassee,Florida,United States",
    "Boise, US": "Boise,Idaho,United States",
    "Springfield, US": "Springfield,Illinois,United States",
    "Des Moines, US": "Des Moines,Iowa,United States",
    "Topeka, US": "Topeka,Kansas,United States",
    "Frankfort, US": "Frankfort,Kentucky,United States",
    "Baton Rouge, US": "Baton Rouge,Louisiana,United States",
    "Augusta, US": "Augusta,Maine,United States",
    "Annapolis, US": "Annapolis,Maryland,United States",
    "Lansing, US": "Lansing,Michigan,United States",
    "St. Paul, US": "St. Paul,Minnesota,United States",
    "Jackson, US": "Jackson,Mississippi,United States",
    "Jefferson City, US": "Jefferson City,Missouri,United States",
    "Helena, US": "Helena,Montana,United States",
    "Lincoln, US": "Lincoln,Nebraska,United States",
    "Carson City, US": "Carson City,Nevada,United States",
    "Concord, US": "Concord,New Hampshire,United States",
    "Trenton, US": "Trenton,New Jersey,United States",
    "Santa Fe, US": "Santa Fe,New Mexico,United States",
    "Albany, US": "Albany,New York,United States",
    "Bismarck, US": "Bismarck,North Dakota,United States",
    "Oklahoma City, US": "Oklahoma City,Oklahoma,United States",
    "Salem, US": "Salem,Oregon,United States",
    "Harrisburg, US": "Harrisburg,Pennsylvania,United States",
    "Providence, US": "Providence,Rhode Island,United States",
    "Columbia, US": "Columbia,South Carolina,United States",
    "Pierre, US": "Pierre,South Dakota,United States",
    "Montpelier, US": "Montpelier,Vermont,United States",
    "Richmond, US": "Richmond,Virginia,United States",
    "Olympia, US": "Olympia,Washington,United States",
    "Charleston, US": "Charleston,West Virginia,United States",
    "Madison, US": "Madison,Wisconsin,United States",
    "Cheyenne, US": "Cheyenne,Wyoming,United States",
    # Australia (20 cities)
    ...
    "Gandhinagar, IN": "Gandhinagar,Gujarat,India",
    "Amaravati, IN": "Amaravati,Andhra Pradesh,India",
    "Jammu, IN": "Jammu,Jammu and Kashmir,India",
    # Germany (10 cities)
    ...
    "Wiesbaden, DE": "Wiesbaden,Hesse,Germany",
    "Schwerin, DE": "Schwerin,Mecklenburg-Vorpommern,Germany",
    "Dresden, DE": "Dresden,Saxony,Germany",
    # France (8 cities)
    ...
    "Rio Branco, BR": "Rio Branco,State of Acre,Brazil",
    "Maceio, BR": "Maceio,State of Alagoas,Brazil",
    "Macapa, BR": "Macapa,State of Amapa,Brazil",
    "Vitoria, BR": "Vitoria,State of Espirito Santo,Brazil",
    "Goiania, BR": "Goiania,State of Goias,Brazil",
    "Sao Luis, BR": "Sao Luis,State of Maranhao,Brazil",
    "Cuiaba, BR": "Cuiaba,State of Mato Grosso,Brazil",
    "Campo Grande, BR": "Campo Grande,State of Mato Grosso do Sul,Brazil",
    "Belem, BR": "Belem,State of Para,Brazil",
    "Joao Pessoa, BR": "Joao Pessoa,State of Paraiba,Brazil",
    "Teresina, BR": "Teresina,State of Piaui,Brazil",
    "Natal, BR": "Natal,State of Rio Grande do Norte,Brazil",
    "Porto Velho, BR": "Porto Velho,State of Rondonia,Brazil",
    "Boa Vista, BR": "Boa Vista,State of Roraima,Brazil",
    "Florianopolis, BR": "Florianopolis,State of Santa Catarina,Brazil",
    "Aracaju, BR": "Aracaju,State of Sergipe,Brazil",
    "Palmas, BR": "Palmas,State of Tocantins,Brazil",
    # Mexico (5 cities)
    ...
    "Aguascalientes, MX": "Aguascalientes,Aguascalientes,Mexico",
    "Mexicali, MX": "Mexicali,Baja California,Mexico",
    "La Paz, MX": "La Paz,Baja California Sur,Mexico",
    "Campeche, MX": "Campeche,Campeche,Mexico",
    "Tuxtla Gutierrez, MX": "Tuxtla Gutierrez,Chiapas,Mexico",
    "Chihuahua, MX": "Chihuahua,Chihuahua,Mexico",
    "Saltillo, MX": "Saltillo,Coahuila,Mexico",
    "Colima, MX": "Colima,Colima,Mexico",
    "Durango, MX": "Durango,Durango,Mexico",
    "Guanajuato, MX": "Guanajuato,Guanajuato,Mexico",
    "Chilpancingo, MX": "Chilpancingo,Guerrero,Mexico",
    "Pachuca, MX": "Pachuca,Hidalgo,Mexico",
    "Toluca, MX": "Toluca,Mexico State,Mexico",
    "Morelia, MX": "Morelia,Michoacan,Mexico",
    "Cuernavaca, MX": "Cuernavaca,Morelos,Mexico",
    "Tepic, MX": "Tepic,Nayarit,Mexico",
    "Oaxaca, MX": "Oaxaca,Oaxaca,Mexico",
    "Queretaro, MX": "Queretaro,Queretaro,Mexico",
    "Chetumal, MX": "Chetumal,Quintana Roo,Mexico",
    "San Luis Potosi, MX": "San Luis Potosi,San Luis Potosi,Mexico",
    "Culiacan, MX": "Culiacan,Sinaloa,Mexico",
    "Hermosillo, MX": "Hermosillo,Sonora,Mexico",
    "Villahermosa, MX": "Villahermosa,Tabasco,Mexico",
    "Ciudad Victoria, MX": "Ciudad Victoria,Tamaulipas,Mexico",
    "Tlaxcala, MX": "Tlaxcala,Tlaxcala,Mexico",
    "Xalapa, MX": "Xalapa,Veracruz,Mexico",
    "Zacatecas, MX": "Zacatecas,Zacatecas,Mexico",
    # Japan (5 cities)
    ...
    "Bhisho, ZA": "Bhisho,Eastern Cape,South Africa",
    "Pietermaritzburg, ZA": "Pietermaritzburg,KwaZulu-Natal,South Africa",
    "Mahikeng, ZA": "Mahikeng,North West,South Africa",
    ...
    "Aba, NG": "Aba,Nigeria",
    "Umuahia, NG": "Umuahia,Abia,Nigeria",
    "Yola, NG": "Yola,Adamawa,Nigeria",
    "Uyo, NG": "Uyo,Akwa Ibom,Nigeria",
    "Awka, NG": "Awka,Anambra,Nigeria",
    "Bauchi, NG": "Bauchi,Bauchi,Nigeria",
    "Yenagoa, NG": "Yenagoa,Bayelsa,Nigeria",
    "Makurdi, NG": "Makurdi,Benue,Nigeria",
    "Maiduguri, NG": "Maiduguri,Borno,Nigeria",
    "Calabar, NG": "Calabar,Cross River,Nigeria",
    "Asaba, NG": "Asaba,Delta,Nigeria",
    "Abakaliki, NG": "Abakaliki,Ebonyi,Nigeria",
    "Ado Ekiti, NG": "Ado Ekiti,Ekiti,Nigeria",
    "Gombe, NG": "Gombe,Gombe,Nigeria",
    "Owerri, NG": "Owerri,Imo,Nigeria",
    "Dutse, NG": "Dutse,Jigawa,Nigeria",
    "Katsina, NG": "Katsina,Katsina,Nigeria",
    "Birnin Kebbi, NG": "Birnin Kebbi,Kebbi,Nigeria",
    "Lokoja, NG": "Lokoja,Kogi,Nigeria",
    "Ilorin, NG": "Ilorin,Kwara,Nigeria",
    "Ikeja, NG": "Ikeja,Lagos,Nigeria",
    "Lafia, NG": "Lafia,Nasarawa,Nigeria",
    "Minna, NG": "Minna,Niger,Nigeria",
    "Abeokuta, NG": "Abeokuta,Ogun,Nigeria",
    "Akure, NG": "Akure,Ondo,Nigeria",
    "Osogbo, NG": "Osogbo,Osun,Nigeria",
    "Jos, NG": "Jos,Plateau,Nigeria",
    "Sokoto, NG": "Sokoto,Sokoto,Nigeria",
    "Jalingo, NG": "Jalingo,Taraba,Nigeria",
    "Damaturu, NG": "Damaturu,Yobe,Nigeria",
    "Gusau, NG": "Gusau,Zamfara,Nigeria",
